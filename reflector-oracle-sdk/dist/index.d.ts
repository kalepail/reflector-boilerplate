...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CCYOZJCOPG34LLQQ7N24YXBM7LL62R7ONMZ3G6WZAAYPB5OYKOMJRN63";
    };
};
export type Asset = {
    tag: "Stellar";
...
export interface Client {
     ...
     */
    x_price: ({ base_asset, quote_asset, timestamp }: {
        base_asset: Asset;
        quote_asset: Asset;
        timestamp: u64;
    }, options?: {
     ...
     */
    x_prices: ({ base_asset, quote_asset, records }: {
        base_asset: Asset;
        quote_asset: Asset;
        records: u32;
    }, options?: {
     ...
     */
    x_twap: ({ base_asset, quote_asset, records }: {
        base_asset: Asset;
        quote_asset: Asset;
        records: u32;
    }, options?: {
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        config: (json: string) => AssembledTransaction<null>;
        add_assets: (json: string) => AssembledTransaction<null>;
        set_period: (json: string) => AssembledTransaction<null>;
        set_price: (json: string) => AssembledTransaction<null>;
        update_contract: (json: string) => AssembledTransaction<null>;
    };
}
